...
public class RayMenu extends RelativeLayout {
	...
	private void init(Context context) {
		...
		li.inflate(R.layout.ivor_ray_menu, this);

		mRayLayout = (RayLayout) findViewById(R.id.ivor_item_layout);
		...
		mHintView = (ImageView) findViewById(R.id.ivor_control_hint);
	}
