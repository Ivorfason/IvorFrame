...
public class PullLayout extends ScrollView {
    ...
    protected void onFinishInflate() {
        ...
        rl_top = findViewById(R.id.ivor_weathertop_rl);
        ll_content = findViewById(R.id.ivor_weathercontent_ll);
        tv = (TextView) findViewById(R.id.ivor_weatherpull_tv);
        ev = (EyeView) findViewById(R.id.ivor_weatherpull_ev);
        ll_weather = findViewById(R.id.ivor_weatherpull_ll);
