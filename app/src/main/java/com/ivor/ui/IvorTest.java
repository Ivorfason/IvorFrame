...
import ivor.sweetalert.SweetAlertDialog;

public class IvorTest extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.custom_img_test:
                new SweetAlertDialog(this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                        ...
                        .setCustomImage(R.mipmap.ivor_boxing)
                        .show();
                break;
